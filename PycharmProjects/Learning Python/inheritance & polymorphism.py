class Animal:
    ...
    def __str__(self):
        return "A {} is {} it is {} it is {}".format(type(self).__name__, self.__birthType, self.__appearance, self.__blooded)
...
class Reptile(Animal):
    ...
    def sumAll(self, *args):  # using splat for unknown number of arguments
        sum = 0
